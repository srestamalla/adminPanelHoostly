        ...
        <div className="px-4 pt-20">
          ...
          <div className="md:px-4 md:w-auto">
            {featuredAdsData.map((item, index) => (
              <div
                key={index}
                className="md:py-2 rounded bg-offWhite shadow-md text-[9px] md:text-[14px] flex justify-center items-center mt-4"
              >
                ...
                <div className="pl-1 md:px-4 py-3 md:w-auto ">
                  <img
                    src={item.image}
                    alt={`${item.name} Image`}
                ...
                <div className="px-1  md:px-4 py-3 font-semibold w-40 md:w-auto">
                ...
                <div className="px-1 md:px-4 py-3 md:w-auto">
                  <button>
